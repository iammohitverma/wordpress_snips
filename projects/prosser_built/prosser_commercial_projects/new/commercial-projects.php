    ...
    while (have_rows('sections')):
        ...
        if (get_row_layout() == 'commercial_projects_sections'):
            ...
            <section class="projects_sec">
                <div class="preloader">
                    <img src="/wp-content/uploads/2024/06/bg_preloader.gif" alt="">
                </div>
                            ...
                            <div class="texonomy">
                                ...
                                $project_categories = get_categories(
                                    array(
                                        ...
                                        'post_type' => 'projects', // Specify the custom post type
                                    )
                                );

                                if ($project_categories) {
                                    ?>
                                    <button class="brdr_btn filter_projects active" role="tab" aria-controls="all"
                                        data-tab="all">All</button>
                                    <?php
                                    foreach ($project_categories as $category) {
                                        echo '<button class="brdr_btn filter_projects" role="tab" aria-controls="' . $category->slug . '" data-tab="' . $category->slug . '">' . $category->name . '</button>';
                                    }
                                } else {
