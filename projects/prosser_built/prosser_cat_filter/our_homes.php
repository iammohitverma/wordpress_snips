<?php
/* Template Name: Residential Our Homes*/ 
...
if (have_rows('sections')):
    ...
    while (have_rows('sections')) : the_row();
        ...
        if (get_row_layout() == 'residential_projects_sections'):
            ...
            <div class="preloader">
                    <img src="/wp-content/uploads/2024/07/preloader2.gif" alt="icon">
                </div>
                <div class="projects_sec_wrap">
                    <div class="container">
                        <div class="sec_heading">
                            ...
                            <div class="categories">
                                ...
                                $project_Category = get_categories(
                                    array(
                                        ...
                                        'taxonomy' => 'our-homes-category', // Specify the taxonomy (usually 'category')
                                        'post_type' => 'our-homes', // Specify the custom post type
                                    ));
                                ...
                                if ($project_Category) {
                                    foreach ($project_Category as $category) {
                                       ...
                                       if ($count == 1) {
                                        ...
                                        echo '"data-tab="' . $category->slug . '" data-post-type="our-homes" data-taxonomy="our-homes-category">' . $category->name . '</button>';
                                        $count++;
                                    }
                                } else {
                            ...
                            <img src="<?php echo esc_url($center_image['url']); ?>" alt="<?php echo esc_attr($center_image['alt']); ?>">
                        </div>
                    </div>
                            ...
                            <?php foreach ($posts as $post): 
                                ...
                                <div class="project_list_images">
                                    <div class="project_image">
                                        <img src="<?php echo esc_url($featured_img_url); ?>" alt="Project image for <?php echo esc_attr($title); ?>">
                                    </div>
