        ...
        ?>
                         ...
                         <div class="listing_wrap">
                            <div class="top">
                                ...
                                <div class="btns_wrap">
                                    <a href=" tel:<?php echo get_field('phone_number'); ?>" class="fasd_btn fill_btn with_icon_img" style="--btnClr:#005E7E">
                                        <i class="icon">
                                    ...
                                    <a href="mailto:<?php the_field('email_address'); ?>" class="fasd_btn outline_btn with_icon_img" style="--btnClr:#005E7E">
                                        <i class="icon">
                                    ...
                                    <a href="<?php echo  get_field('website_url') ; ?>" class="fasd_btn outline_btn with_icon_img" style="--btnClr:#005E7E">
