...
if ( ! function_exists( 'promarkerd_theme_setup' ) ) :
	...
	function promarkerd_theme_setup() {
        ...
        function presentation_load_more() {
            $html_data = '<div class="tabs-wrapping presentation_posts">';
                    $args = array(
                        'post_type' => 'news',
                        'posts_per_page' => -1,
                        'post_status' => 'publish',
        ...
        function media_load_more() {
            $html_data = '<div class="row media_posts">';
                    $args = array(
                        'post_type' => 'news',
                        'posts_per_page' => -1,
                        'post_status' => 'publish',
                            ...
                            $html_data .= '<div class="col-lg-4 col-md-6 col-tab">
                                <div class="card">
                                    <div class="card-figure">';
                                        $html_data .= '<img src="' . get_the_post_thumbnail_url(). '" class="img-fluid" alt="tab-figure-1">';
                                        // $html_data.= '<h6 class="tatest-hdng">LATEST NEWS</h6>';
                                    $html_data.='</div>
                                    <div class="card-body">
                                        <ul>';
                                            $html_data .= '<li>' . get_the_date('F j, Y'). '</li>';
                                            // $html_data .= '<li>4min read</li>';
                                        $html_data .= '</ul> ';
                                        // $html .= '<p class="desc">' . get_the_author(). '</p>';

                                        $html_data .= '<h4 class="hdng">' . get_the_title(). '</h4>';

                                        $html_data .= '<a href="' .get_the_permalink() . '" class="btn btn-success">Read More <img src="/wp-content/uploads/2024/08/publication_arrows.svg" alt="icon"></a>
                                    </div>
                                </div>
                            </div> ';
                        }
