...
if (!function_exists('admin_login')):
    ...
    function login_page_design()
    {
        ...
        // get logo    
        $custom_logo_id = get_option('admin_logo');
        ?>
        <style type="text/css">
            * {
            ...
            /* Logo Style */
            .login h1 a {
                background-image: url(<?php echo esc_url($custom_logo_id) ?>) !important;
            ...
            body.login::before {
                content: "";
                background:
                    <?php echo get_theme_mod('background_overlay'); ?>
                ;
                position: absolute;
                top: 0;
                left: 0;
            ...
            div#login form {
                border-radius: 7px;
                background-color:
                    <?php echo get_theme_mod('form_box_bg'); ?>
                ;
            }
            ...
            #loginform label {
                ...
                font-weight: 600;
                color:
                    <?php echo get_theme_mod('form_text_color'); ?>
                ;
            }
            ...
            #loginform input[type="password"] {
                ...
                border: 0px;
                background:
                    <?php echo get_theme_mod('form_field_background'); ?>
                ;
                padding: 0 15px;
            ...
            #loginform .forgetmenot label::after {
                ...
                content: "";
                background:
                    <?php echo get_theme_mod('login_buttons_background'); ?>
                ;
                position: absolute;
                left: 3px;
                top: 4px;
            ...
            #loginform .submit #wp-submit {
                ...
                ;
                color:
                    <?php echo get_theme_mod('login_button_color'); ?>
                ;
                border: 1px solid
                    <?php echo get_theme_mod('login_buttons_background'); ?>
                ;
            ...
            #backtoblog a {
                width: 100%;
                background:
                    <?php echo get_theme_mod('buttons_background'); ?>
                ;
                ...
                text-align: center;
                color:
                    <?php echo get_theme_mod('buttons_color'); ?>
                    !important;
                display: block;
                border-radius: 6px;
                transition: 0.5s ease;
