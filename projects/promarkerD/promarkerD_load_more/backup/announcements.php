        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                ...
                <div class="button_wrap">
                        <button class="common_btn" id="announcement_load_more_btn">View more</button>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                ...
                <div class="button_wrap">
                    <button href="#" class="common_btn" id="presentation_load_more_btn">View more</button>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"
                ...
                <?php
                    ...
                    <div class="button_wrap">
                        <button href="#" class="common_btn" id="media_load_more_btn">View more</button>
                    </div>
                </div>
            </div>
        </div>
