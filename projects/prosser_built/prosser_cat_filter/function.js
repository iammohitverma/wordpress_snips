jQuery(function ($) {
  ...
  function filterProjects() {
    ...
    var postType = $(".filter_projects.active").data("post-type");
    var taxonomy = $(".filter_projects.active").data("taxonomy");
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.length > 0) {
          ...
          $(".projects_sec").removeClass("not_found");
          ...
          $(".projects_sec").addClass("not_found");
          $(".project_list").html(
