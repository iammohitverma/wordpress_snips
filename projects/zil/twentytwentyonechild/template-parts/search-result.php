...
<section class="search-result">
    <div class="container">
        ...
        <?php if (have_posts()): ?>
                    ...
                    <div class="col-lg-8">
                        <div class="post-content">
                            ...
                            <div class="post-meta">
                                ...
                                <span> by <a
                                        href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><strong><?php the_author(); ?></strong></a>
                                    <?php the_date(); ?> | <?php the_time(); ?></span>
            ...
            <div>
                <h5 class="alert alert-danger text-center">No Search result found for = <?php echo get_search_query(); ?>
                </h5>
            </div>
        <?php endif; ?>
        <div class="row">
