...
if ( ! function_exists( 'jc_tbo_theme_setup' ) ) :
	...
	function jc_tbo_theme_setup() {
        ...
        function jc_tbo_scripts() {
            ...
            wp_enqueue_style( 'jc_tbo-font-style', get_template_directory_uri() . '/assets/fonts/stylesheet.css',false, _JN_VERSION,'all');
            ...
            wp_enqueue_style( 'jc_tbo-swiper-style', get_template_directory_uri() . '/assets/css/swiper/swiper.min.css',false, _JN_VERSION,'all');
            ...
            wp_enqueue_script( 'jc_tbo-swiper-script', get_template_directory_uri() . '/assets/js/swiper/swiper_bundle.min.js', array(), _JN_VERSION, true );
            ...
            wp_enqueue_script( 'jc_tbo-lenis-script', get_template_directory_uri() . '/assets/js/gsap/gsap_scroll.js', array(), _JN_VERSION, true );
